package com.bolsaideas.springboot.webflux;
...
import com.bolsaideas.springboot.webflux.models.dao.ProductoDao;
...
public class SpringBootWebfluxApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Flux.just(new Producto("TV Panasonic Pantalla LCD", 456.89), new Producto("Sony Camara HD Digital", 177.89),
                ...
                new Producto("TV Sony Bravia OLED 4K Ultra HD", 2255.89)).flatMap(producto -> {
